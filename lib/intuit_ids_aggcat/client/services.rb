  ...
  module Client
    ...
    class Services
      ...
      class << self
        ...
        def delete_customer_em em_deferrable, oauth_token_info, consumer_key = IntuitIdsAggcat.config.oauth_consumer_key, consumer_secret = IntuitIdsAggcat.config.oauth_consumer_secret
          ...
          operation = lambda {
            begin 
              ...
              handle_exception(e, "delete_customer_em", em_deferrable)
            end   
          }
        ...
        def delete_account_em em_deferrable, account_id, oauth_token_info, consumer_key = IntuitIdsAggcat.config.oauth_consumer_key, consumer_secret = IntuitIdsAggcat.config.oauth_consumer_secret
          ...
          operation = lambda {
            begin
              ...
              handle_exception(e, "delete_account_em", em_deferrable)
            end   
          }
          callback = lambda { |request_response| 
            begin
        ...
        def discover_and_add_accounts_with_credentials_em em_deferrable, institution_id, creds_hash, oauth_token_info, consumer_key = IntuitIdsAggcat.config.oauth_consumer_key, consumer_secret = IntuitIdsAggcat.config.oauth_consumer_secret, timeout = 30
          ...
          operation = lambda {
            begin 
              ...
              handle_exception(e, "discover_and_add_new_accounts_with_credentials", em_deferrable)
            end
          }
          callback = lambda { |result| 
            begin 
        ...
        def handle_exception(e, function_name, em_deferrable)
          msg = "Exception in #{function_name}\n#{e.backtrace.join("\n")}"
        ...
        def get_customer_accounts_em em_deferrable, oauth_token_info, consumer_key = IntuitIdsAggcat.config.oauth_consumer_key, consumer_secret = IntuitIdsAggcat.config.oauth_consumer_secret
          ...
          operation = lambda {
            begin 
              ...
              handle_exception(e, "get_customer_accounts_em", em_deferrable)
            end   
          }
          callback = lambda { |result| 
            begin 
        ...
        def get_login_accounts_em em_deferrable, login_id, username, oauth_token_info, consumer_key = IntuitIdsAggcat.config.oauth_consumer_key, consumer_secret = IntuitIdsAggcat.config.oauth_consumer_secret
          ...
          operation = lambda {
            begin
              ...
              handle_exception(e, "get_login_accounts_em", em_deferrable)
            end   
          }
          callback = lambda { |result| 
            begin
        ...
        def get_account_transactions_em em_deferrable, account_id, start_date, end_date, oauth_token_info, consumer_key = IntuitIdsAggcat.config.oauth_consumer_key, consumer_secret = IntuitIdsAggcat.config.oauth_consumer_secret
          ...
          operation = lambda {
            begin
              ...
              handle_exception(e, "get_account_transactions_em", em_deferrable)
            end   
          }
          callback = lambda { |result| 
            begin
